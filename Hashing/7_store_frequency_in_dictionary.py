...
def test_store_frequency():
    nums = [5, 6, 7, 7, 1, 9, 111, 1, 1, 5, 1, 1]
    print("Using dictionary method:", store_frequency_in_dictionary(nums))
    print("Using Counter method:", store_frequency_in_dictionary_with_counter(nums))
    print("Using HashMap method:", store_frequency_in_dictionary_with_hashmap(nums))

# Running the test function to see the results
test_store_frequency()
# This function tests all three methods and prints the frequency maps generated by each method.
